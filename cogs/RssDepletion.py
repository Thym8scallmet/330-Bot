...
class RssDepletion(commands.Cog):
  ...
  @app_commands.command(name='rss_depletion', description='Calculate resource depletion time using a modal')
  ...
  async def rss_help(self, interaction: discord.Interaction):
      embed = discord.Embed(
          ...
          description=(
              "To use this bot, you must use `/rss_depletion`.\n\n"
              "The command will bring up a form asking you to provide 2 values. To obtain these values:\n"
